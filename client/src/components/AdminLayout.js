...
export default function AdminLayout() {
  ...
  return (
    <div className="admin-container" style={{ display: "flex", minHeight: "100vh", background: "#f5f0e8" }}>
      {/* Sidebar */}
      <aside className="admin-sidebar" style={{
        ...
        <div className="admin-sidebar-header" style={{ padding: collapsed ? "1.5rem 0.8rem" : "1.5rem", borderBottom: "1px solid rgba(201,168,76,0.2)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <nav className="admin-sidebar-nav" style={{ flex: 1, padding: "1rem 0" }}>
        ...
        <div className="admin-sidebar-footer" style={{ padding: collapsed ? "1rem 0.5rem" : "1rem 1.5rem", borderTop: "1px solid rgba(255,255,255,0.08)" }}>
      ...
      {/* Main content */}
      <main className="admin-main" style={{ flex: 1, padding: "2rem", overflowX: "auto" }}>
        <Outlet />
      </main>
    </div>
  );
